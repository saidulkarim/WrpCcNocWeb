...
namespace WrpCcNocWeb.Models
{
    public class CcModAppProjectCommonDetail
    {
        ...
        [Required]
        [Column("ProjectObjective", Order = 7)]
        [Display(Name = "Objectives")]
        [MaxLength(450)]
        public string ProjectObjective { get; set; }


        [Column("ProjectActivity", Order = 8)]
        ...
        [Column("AnalyzeOptionsApplicantCmt", Order = 26)]
        [Display(Name = "Applicant Comments")]
        [MaxLength(150)]
        public string AnalyzeOptionsApplicantCmt { get; set; }


        [Column("AnalyzeOptionsAuthorityCmt", Order = 27)]
        [Display(Name = "Authority Comments")]
        [MaxLength(150)]
        public string AnalyzeOptionsAuthorityCmt { get; set; }


        [Column("EnvAndSocialYesNoId", Order = 28)]
        ...
        [Column("EnvAndSocialApplicantCmt", Order = 29)]
        [Display(Name = "Applicant Comments")]
        [MaxLength(150)]
        public string EnvAndSocialApplicantCmt { get; set; }


        [Column("EnvAndSocialAuthorityCmt", Order = 30)]
        [Display(Name = "Authority Comments")]
        [MaxLength(150)]
        public string EnvAndSocialAuthorityCmt { get; set; }


        [Column("CompatNWPYesNoId", Order = 31)]
        ...
        [Column("NWMPApplicantCmt", Order = 36)]
        [Display(Name = "Applicant Comments")]
        [MaxLength(150)]
        public string NWMPApplicantCmt { get; set; }


        [Column("NWMPAuthorityCmt", Order = 37)]
        [Display(Name = "Authority Comments")]
        [MaxLength(150)]
        public string NWMPAuthorityCmt { get; set; }


        [Column("NWMPDocLink", Order = 38)]
        [Display(Name = "Document Link")]
        [MaxLength(250)]
        public string NWMPDocLink { get; set; }


        [Column("FYPYesNoId", Order = 39)]
        ...
        [Column("FYPApplicantCmt", Order = 40)]
        [Display(Name = "Applicant Comments")]
        [MaxLength(150)]
        public string FYPApplicantCmt { get; set; }


        [Column("FYPAuthorityCmt", Order = 41)]
        [Display(Name = "Authority Comments")]
        [MaxLength(150)]
        public string FYPAuthorityCmt { get; set; }


        [Column("SDGYesNoId", Order = 42)]
        ...
        [Column("SDGApplicantCmt", Order = 43)]
        [Display(Name = "Applicant Comments")]
        [MaxLength(150)]
        public string SDGApplicantCmt { get; set; }


        [Column("SDGAuthorityCmt", Order = 44)]
        [Display(Name = "Authority Comments")]
        [MaxLength(150)]
        public string SDGAuthorityCmt { get; set; }


        [Column("SDGDocLink", Order = 45)]
        [Display(Name = "Document Link")]
        [MaxLength(250)]
        public string SDGDocLink { get; set; }


        [Column("DeltaPlanYesNoId", Order = 46)]
        ...
        [Column("DeltaPlan2100ApplicantCmt", Order = 47)]
        [Display(Name = "Applicant Comments")]
        [MaxLength(150)]
        public string DeltaPlan2100ApplicantCmt { get; set; }


        [Column("DeltaPlan2100AuthorityCmt", Order = 48)]
        [Display(Name = "Authority Comments")]
        [MaxLength(150)]
        public string DeltaPlan2100AuthorityCmt { get; set; }


        [Column("DeltaPlan2100DocLink", Order = 49)]
        [Display(Name = "Document Link")]
        [MaxLength(250)]
        public string DeltaPlan2100DocLink { get; set; }


        [Column("CostalZoneYesNoId", Order = 50)]
        ...
        [Column("CostalZoneApplicantCmt", Order = 51)]
        [Display(Name = "Applicant Comments")]
        [MaxLength(150)]
        public string CostalZoneApplicantCmt { get; set; }


        [Column("CostalZoneAuthorityCmt", Order = 52)]
        [Display(Name = "Authority Comments")]
        [MaxLength(150)]
        public string CostalZoneAuthorityCmt { get; set; }


        [Column("CostalZoneDocLink", Order = 53)]
        [Display(Name = "Document Link")]
        [MaxLength(250)]
        ...
        [Column("AgriculturalYesNoId", Order = 54)]
        ...
        [Column("AgriApplicantCmt", Order = 55)]
        [Display(Name = "Applicant Comments")]
        [MaxLength(150)]
        public string AgriApplicantCmt { get; set; }


        [Column("AgriAuthorityCmt", Order = 56)]
        [Display(Name = "Authority Comments")]
        [MaxLength(150)]
        public string AgriAuthorityCmt { get; set; }


        [Column("AgriDocLink", Order = 57)]
        [Display(Name = "Document Link")]
        [MaxLength(250)]
        public string AgriDocLink { get; set; }


        [Column("FisheriesYesNoId", Order = 58)]
        ...
        [Column("FisheriesApplicantCmt", Order = 59)]
        [Display(Name = "Applicant Comments")]
        [MaxLength(150)]
        public string FisheriesApplicantCmt { get; set; }


        [Column("FisheriesAuthorityCmt", Order = 60)]
        [Display(Name = "Authority Comments")]
        [MaxLength(150)]
        public string FisheriesAuthorityCmt { get; set; }


        [Column("FisheriesDocLink", Order = 61)]
        [Display(Name = "Document Link")]
        [MaxLength(250)]
        public string FisheriesDocLink { get; set; }


        [Column("IWRMYesNoId", Order = 62)]
        ...
        [Column("IWRMApplicantCmt", Order = 63)]
        [Display(Name = "Applicant Comments")]
        [MaxLength(150)]
        public string IWRMApplicantCmt { get; set; }


        [Column("IWRMAuthorityCmt", Order = 64)]
        [Display(Name = "Authority Comments")]
        [MaxLength(150)]
        public string IWRMAuthorityCmt { get; set; }


        [Column("GPWMYesNoId", Order = 65)]
        ...
        [Column("GPWMApplicantCmt", Order = 66)]
        [Display(Name = "Applicant Comments")]
        [MaxLength(150)]
        public string GPWMApplicantCmt { get; set; }


        [Column("GPWMAuthorityCmt", Order = 67)]
        [Display(Name = "Authority Comments")]
        [MaxLength(150)]
        public string GPWMAuthorityCmt { get; set; }


        [Column("FeasibilityYesNoId", Order = 68)]
        ...
        [Column("FeasibilityApplicantCmt", Order = 69)]
        [Display(Name = "Applicant Comments")]
        [MaxLength(150)]
        public string FeasibilityApplicantCmt { get; set; }


        [Column("FeasibilityAuthorityCmt", Order = 70)]
        [Display(Name = "Authority Comments")]
        [MaxLength(150)]
        public string FeasibilityAuthorityCmt { get; set; }


        [Column("SocialIssuesYesNoId", Order = 71)]
        ...
        [Column("SocialIssuesApplicantCmt", Order = 72)]
        [Display(Name = "Applicant Comments")]
        [MaxLength(150)]
        public string SocialIssuesApplicantCmt { get; set; }


        [Column("SocialIssuesAuthorityCmt", Order = 73)]
        [Display(Name = "Authority Comments")]
        [MaxLength(150)]
        public string SocialIssuesAuthorityCmt { get; set; }


        [Column("BankDocTypeId", Order = 74)]
