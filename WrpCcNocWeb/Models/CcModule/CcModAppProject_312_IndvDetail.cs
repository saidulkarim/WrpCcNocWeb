...
namespace WrpCcNocWeb.Models
{
    public class CcModAppProject_312_IndvDetail
    {
        ...
        [Column("PotGrndWtrRechargeId", Order = 5)]
        [Display(Name = "Potential Ground Water Recharge")]
        public int? PotGrndWtrRechargeId { get; set; }
        [ForeignKey("PotGrndWtrRechargeId")]
        public virtual LookUpCcModPotGrndWtrRecharge LookUpCcModPotGrndWtrRecharge { get; set; }
        ...
        [Display(Name = "Distance (m) from Proposed Extraction Well")]
        public double? NearestSurfWaterAvailDistance { get; set; }
