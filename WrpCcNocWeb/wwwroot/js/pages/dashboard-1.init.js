!function (l) {
    ...
    o.prototype.createCombineGraph = function (o, t, a, e) {
        var i = [{ label: a[0], data: e[0], lines: { show: !0, fill: !0 }, points: { show: !0 } }, { label: a[1], data: e[1], lines: { show: !0 }, points: { show: !0 } }, { label: a[2], data: e[2], bars: { show: !0, barWidth: .7 } }], r = { series: { shadowSize: 0 }, grid: { hoverable: !0, clickable: !0, tickColor: "#f9f9f9", borderWidth: 1, borderColor: "#eeeeee" }, colors: ["#e3eaef", "#4a81d4", "#1abc9c"], tooltip: !0, tooltipOpts: { defaultTheme: !1 }, legend: { position: "ne", margin: [0, -32], noColumns: 0, labelBoxBorderColor: null, labelFormatter: function (o, t) { return o + "&nbsp;&nbsp;" }, width: 30, height: 2 }, yaxis: { axisLabel: "Point Value (1000)", tickColor: "#f5f5f5", font: { color: "#bdbdbd" } }, xaxis: { axisLabel: "Daily Hours", ticks: t, tickColor: "#f5f5f5", font: { color: "#bdbdbd" } } }; l.plot(l(o), i, r)
    },
