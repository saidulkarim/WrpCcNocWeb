!function (e, t) {
    ...
    function (e, t) {
                    ...
                    if (!this._element.disabled && !p(this._element).hasClass(Nt)) {
                        ...
                        if (u._clearMenus(), !t) {
                            ...
                            if (p(e).trigger(i), !i.isDefaultPrevented()) {
                                if (!this._inNavbar) {
                                    if (void 0 === wt) throw new TypeError("Bootstrap's dropdowns require Popper.js (popper.js.org)");
                                    var r = this._element;
        ...
        var En = "tooltip",
            ...
            Un = function () {
                function i(e, t) {
                    if (void 0 === wt) throw new TypeError("Bootstrap's tooltips require Popper.js (popper.js.org)");
