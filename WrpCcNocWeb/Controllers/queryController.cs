            ...
            try
            {
                ...
                pqvl = (from qd in _db.CcModProjectQueryDetail
                        ...
                        select new ProjectQueryViewList
                        {
                            ...
                            SenderFullName = sdi.ApplicantTypeId == 1 ? sdi.ApplicantName : sdi.OrganizationName, //sdi.UserFullName,
                            ...
                            ReceiverFullName = rei.ApplicantTypeId == 1 ? rei.ApplicantName : rei.OrganizationName, //rei.UserFullName,
