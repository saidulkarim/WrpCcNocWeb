...
namespace WrpCcNocWeb.Controllers
{
    public class formController : Controller
    {
                        ...
                        if (ug != null)
                        {
                            _ui = (from gdd in _db.AdminModUserGrpDistDetail
                                   ...
                                   select new UserInfo
                                   {
                                       ...
                                       UserFullName = ui.ApplicantTypeId == 1 ? ui.ApplicantName : ui.OrganizationName,
        ...
        private void GetF34ViewData(long id)
        {
            UserInfo ui = HttpContext.Session.GetComplexData<UserInfo>("LoggerUserInfo");
            System.Globalization.DateTimeFormatInfo mfi = new System.Globalization.DateTimeFormatInfo();
            SelectedForm sf = HttpContext.Session.GetComplexData<SelectedForm>("SelectedForm");
            ...
            ViewData["HydrologicalRegionDetail"] = _hydroregiondetail;
            ...
            List<CcModUsDsConditionDetailTemp> _usdsconditiondetail = controls.GetUsDsConditionDetail(pcd.ProjectId);
            ViewData["UsDsConditionDetailTemp"] = _usdsconditiondetail;
            ...
            ViewData["ProjectId"] = pcd.ProjectId;
            ViewData["ProjectIndvId"] = _db.CcModAppProject_34_IndvDetail.Where(w => w.ProjectId == pcd.ProjectId).Select(s => s.Project34IndvId).FirstOrDefault();
            ViewData["UserId"] = ui.UserID;
            ViewData["ProjectTypeId"] = pcd.ProjectTypeId;
        ...
        private void GetF35ViewData(long id)
        {
            UserInfo ui = HttpContext.Session.GetComplexData<UserInfo>("LoggerUserInfo");
            System.Globalization.DateTimeFormatInfo mfi = new System.Globalization.DateTimeFormatInfo();
            SelectedForm sf = HttpContext.Session.GetComplexData<SelectedForm>("SelectedForm");
            ...
            ViewData["ProjectId"] = pcd.ProjectId;
            ViewData["ProjectIndvId"] = _db.CcModAppProject_35_IndvDetail.Where(w => w.ProjectId == pcd.ProjectId).Select(s => s.Project35IndvId).FirstOrDefault();
            ViewData["UserId"] = ui.UserID;
            ViewData["ProjectTypeId"] = pcd.ProjectTypeId;
        ...
        private void GetF36ViewData(long id)
        {
            UserInfo ui = HttpContext.Session.GetComplexData<UserInfo>("LoggerUserInfo");
            System.Globalization.DateTimeFormatInfo mfi = new System.Globalization.DateTimeFormatInfo();
            SelectedForm sf = HttpContext.Session.GetComplexData<SelectedForm>("SelectedForm");
            ...
            ViewData["ProjectId"] = pcd.ProjectId;
            ViewData["ProjectIndvId"] = _db.CcModAppProject_36_IndvDetail.Where(w => w.ProjectId == pcd.ProjectId).Select(s => s.Project36IndvId).FirstOrDefault();
            ViewData["UserId"] = ui.UserID;
            ViewData["ProjectTypeId"] = pcd.ProjectTypeId;
        ...
        private void GetF37ViewData(long id)
        {
            UserInfo ui = HttpContext.Session.GetComplexData<UserInfo>("LoggerUserInfo");
            System.Globalization.DateTimeFormatInfo mfi = new System.Globalization.DateTimeFormatInfo();
            SelectedForm sf = HttpContext.Session.GetComplexData<SelectedForm>("SelectedForm");
            ...
            ViewData["ProjectId"] = pcd.ProjectId;
            ViewData["ProjectIndvId"] = _db.CcModAppProject_37_IndvDetail.Where(w => w.ProjectId == pcd.ProjectId).Select(s => s.Project37IndvId).FirstOrDefault();
            ViewData["UserId"] = ui.UserID;
            ViewData["ProjectTypeId"] = pcd.ProjectTypeId;
        ...
        private void GetF38ViewData(long id)
        {
            UserInfo ui = HttpContext.Session.GetComplexData<UserInfo>("LoggerUserInfo");
            System.Globalization.DateTimeFormatInfo mfi = new System.Globalization.DateTimeFormatInfo();
            SelectedForm sf = HttpContext.Session.GetComplexData<SelectedForm>("SelectedForm");
            ...
            ViewData["ProjectId"] = pcd.ProjectId;
            ViewData["ProjectIndvId"] = _db.CcModAppProject_38_IndvDetail.Where(w => w.ProjectId == pcd.ProjectId).Select(s => s.Project38IndvId).FirstOrDefault();
            ViewData["UserId"] = ui.UserID;
            ViewData["ProjectTypeId"] = pcd.ProjectTypeId;
        ...
        private void GetF313ViewData(long id)
        {
            UserInfo ui = HttpContext.Session.GetComplexData<UserInfo>("LoggerUserInfo");
            System.Globalization.DateTimeFormatInfo mfi = new System.Globalization.DateTimeFormatInfo();
            SelectedForm sf = HttpContext.Session.GetComplexData<SelectedForm>("SelectedForm");
            ...
            ViewData["ProjectId"] = pcd.ProjectId;
            ViewData["ProjectIndvId"] = _db.CcModAppProject_313_IndvDetail.Where(w => w.ProjectId == pcd.ProjectId).Select(s => s.Project313IndvId).FirstOrDefault();
            ViewData["UserId"] = ui.UserID;
            ViewData["ProjectTypeId"] = pcd.ProjectTypeId;
            ViewData["Title"] = "Application for Clearance of Other Projects Considered by the DG | Print";
            ViewData["ProjectTypeTitle"] = _db.LookUpCcModProjectType.Where(w => w.ProjectTypeId == pcd.ProjectTypeId).Select(s => s.ProjectType).FirstOrDefault();
            ViewData["ProjectTypeTitleBn"] = _db.LookUpCcModProjectType.Where(w => w.ProjectTypeId == pcd.ProjectTypeId).Select(s => s.ProjectTypeBn).FirstOrDefault();
            ViewData["LanguageId"] = pcd.LanguageId;
            ViewData["SignatureFileName"] = _db.AdminModUsersDetail.Where(w => w.UserId == pcd.UserId).Select(s => s.ApplicantSignature).FirstOrDefault();
        ...
        public IActionResult printfcmp(long id)
        {
            UserInfo ui = HttpContext.Session.GetComplexData<UserInfo>("LoggerUserInfo");
            System.Globalization.DateTimeFormatInfo mfi = new System.Globalization.DateTimeFormatInfo();
        ...
        public IActionResult wldp()
        {
            ...
            ViewData["Title"] = sf.LanguageTypeId == "1" ? "বন্যা প্লাবিত সমতল ভূমি বা জলাভূমি উন্নয়ন প্রকল্প" : "Wetland Development Project";
            ViewBag.ProjectTypeId = sf.ProjectTypeId;
            ViewBag.ProjectTitle = sf.ProjectTitle;
        ...
        public IActionResult fcdi()
        {
            ...
            if (_psi != null)
                GetF313ViewData(_psi.ProjectId);
        ...
        */
                    ...
                    try
                    {
                        ...
                        if (result > 0)
                        {
                            ...
                            else
                            {
                                ...
                                p34i.RiverTrainingWorksLoc = Project34Indv.RiverTrainingWorksLoc;
                                p34i.RiverTrainingWorksQuantity = Project34Indv.RiverTrainingWorksQuantity;
                                #endregion
        ...
        #region Form 3.5 > Surface Water Reservation Project
        //Tehnical Info
        //form/Form34TechInfoOneToOneSave :: f35tiotos
        [HttpPost]
        ...
        #region Form 3.6 > Wetland Development Project
        //Tehnical Info
        //form/Form34TechInfoOneToOneSave :: f36tiotos
        [HttpPost]
                    ...
                    try
                    {
                        ...
                        if (result > 0)
                        {
                            ...
                            else
                            {
                                ...
                                p37i.IsSpecializedIndustrialZone = Project37Indv.IsSpecializedIndustrialZone;
        ...
        public JsonResult gfc(long userid, int projtypeid, long projid, string controlname)
        {
            var comments = (from d in _db.CcModAppProjDataAnalysis
                            ...
                            select new FormCommentsListTemp
                            {
                                ...
                                UserName = String.Format("{0}, {1}", user.ApplicantTypeId == 1 ? user.ApplicantName : user.OrganizationName, ugl.UserGroupName),
